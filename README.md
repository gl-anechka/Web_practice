...
В каталоге _db_ лежат sql-скрипты создания базы данных для приложения. Файл сборки ```build.xml``` находится в корневом каталоге. 
В калалоге _docs_ документы, описывающие базу данных, страницы и сценарии работы приложения.
